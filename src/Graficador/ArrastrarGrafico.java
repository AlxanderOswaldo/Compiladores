...
public class ArrastrarGrafico extends Canvas implements MouseMotionListener
{
  ...
  /** 
    ...
    public void paint(Graphics g)
    {
        ...
        g.fillOval(xRectangulo, yRectangulo, anchoRectangulo, altoRectangulo);
          g.setColor(Color.BLUE);
        g.fillRect(xRectangulo+20, yRectangulo+20, anchoRectangulo, altoRectangulo);
          g.setColor(Color.BLACK);
        g.fillOval(xRectangulo+100, yRectangulo+100, anchoRectangulo, altoRectangulo);
    }
  public Graphics figura(Graphics g){
       g.setColor(Color.RED);       
        g.fillOval(xRectangulo, yRectangulo, anchoRectangulo, altoRectangulo);
      return g;
    ...
    public static void main(String[] args)
    {
        ...
        ArrastrarGrafico c = new ArrastrarGrafico();
         ArrastrarGrafico d = new ArrastrarGrafico();
