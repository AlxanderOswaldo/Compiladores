...
public class NodoG implements Serializable{
    ...
    private NodoG nodoAntecesorDisjktra; //Para uso de la clase Disjktra
    ...
    public NodoG(Object dato,Coordenadas coordenada){
        this.dato = dato;
   ...
   public void addNodoAdyacente(Enlace arista){
    ...
    public void addNodoAdyacente(Arista via,NodoG nodo){
    ...
    public NodoG getNodoAntecesorDisjktra() {
        return nodoAntecesorDisjktra;
    }

    public void setNodoAntecesorDisjktra(NodoG nodoAntecesorDisjktra) {
